"""
Django settings for noisy_flower_42872 project.
...
ROOT_URLCONF = 'noisy_flower_42872.urls'
...
WSGI_APPLICATION = 'noisy_flower_42872.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_flower_42872 API",
    "DESCRIPTION": "API documentation for noisy_flower_42872 App",
    "VERSION": "v1",
}
